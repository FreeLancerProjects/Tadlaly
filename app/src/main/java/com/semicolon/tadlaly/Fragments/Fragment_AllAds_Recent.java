...
import com.semicolon.tadlaly.Adapters.FragmentAllAds_RecentAdapter;
...
public class Fragment_AllAds_Recent extends Fragment implements UserSingleTone.OnCompleteListener,LatLngSingleTone.onLatLngSuccess{
    private static final String TAG="user_type";
    private RecyclerView recView;
    private FragmentAllAds_RecentAdapter adapter;
    ...
    public static Fragment_AllAds_Recent getInstance(String user_type)
    {
        Bundle bundle = new Bundle();
        bundle.putString(TAG,user_type);
        Fragment_AllAds_Recent fragment_allAds_nearby = new Fragment_AllAds_Recent();
    ...
    private void initView(View view) {
        ...
        if (bundle!=null)
        {
            ...
            if (user_type.equals(Tags.app_user))
            {
                ...
                adapter = new FragmentAllAds_RecentAdapter(recView,getActivity(),myAdsModelList,this,true);
            ...
            }else if (user_type.equals(Tags.app_visitor))
            {
                ...
                user_id = "all";
                adapter = new FragmentAllAds_RecentAdapter(recView,getActivity(),myAdsModelList,this,false);
                recView.setAdapter(adapter);
    ...
    private void UpdateUI(String user_id)
    {
        ...
        Api.getRetrofit(Tags.Base_Url)
                ...
                .getAllAdsBasedOn_New_Nearby(user_id,Tags.display_new,page_index,String.valueOf(myLat),String.valueOf(myLng))
    ...
    private void initLoadMore() {
        ...
        adapter.setLoadListener(new FragmentAllAds_RecentAdapter.OnLoadListener() {
            @Override
                ...
                .enqueue(new Callback<List<MyAdsModel>>() {
                    ...
                    public void onResponse(Call<List<MyAdsModel>> call, Response<List<MyAdsModel>> response) {
                        if (response.isSuccessful())
                        {
                            if (response.body().size()>0)
                            {
                                Fragment_AllAds_Recent.this.page_index = Fragment_AllAds_Recent.this.page_index+1;
